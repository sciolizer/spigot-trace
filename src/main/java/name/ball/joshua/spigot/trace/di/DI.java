    ...
    private static class FactorySchema {
        ...
        public Object newInstance(Object[] args) throws Throwable {
            ...
            try {
                ...
                throw e.getTargetException(); // todo: add a check for this when the factory is constructed; factory exception declarations must be a super set of constructor exception declarations
            }
